...
위의 코드에서 2차원 배열에 대해 배열연산을 한번만 수행하면, 즉 `aList[0]`라고 한다면 이것은 **주소**를 의미하는 [**r-value**](https://msdn.microsoft.com/ko-kr/library/bkbs2cds.aspx) 이다. 따라서, `aList[0]`은 0번 행 전체를 의미하는 **주소상수**이다.
